...
The best cross-evaluation score for this model was a **mean squared error** of **19.26**. We can loosely interpret this as saying our model is, on average, 19.26 IMDb rating points off from the actual score.
